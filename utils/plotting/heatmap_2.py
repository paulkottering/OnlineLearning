...
def plot_heatmap(varying_parameters, varying_values, data_ne, data_p, data_ni, fixed_parameters):
    ...
    sns.heatmap(data_p, annot=True, fmt=".2f", xticklabels=varying_values[1], yticklabels=varying_values[0], ax=axes[1],cmap='Blues')
    ...
    if not os.path.exists("Figures"):
        os.makedirs("Figures")
    title = "Figures/5_3.png".format(varying_parameters[0], varying_parameters[1])
